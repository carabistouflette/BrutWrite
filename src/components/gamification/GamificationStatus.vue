...
import GamificationDashboard from './GamificationDashboard.vue';
...
<template>
  <div class="relative z-50">
    ...
    >
      ...
      <div
        class="flex flex-col items-start leading-none opacity-60 group-hover:opacity-100 transition-opacity"
      >
