                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <button 
                                v-for="role in roles" 
                                :key="role"
                                @click="() => { modelValue.role = role; handleChange(); }"
                                class="px-4 py-2 rounded-lg text-sm transition-all border font-bold"
                                :class="modelValue.role === role ? 'bg-ink text-paper! border-ink shadow-md' : 'bg-transparent border-ink/10 text-ink/60 hover:border-ink/30'"
                            >
