...
import IntelligenceSettings from './IntelligenceSettings.vue';
...
const activeTab = ref<'general' | 'editor' | 'interface' | 'intelligence'>('general');
      ...
      <div v-if="show" class="fixed inset-0 z-50 flex items-center justify-center p-4 lg:p-12">
        ...
        >
          ...
          <div class="w-64 bg-paper/30 border-r border-ink/5 flex flex-col">
            ...
            <div
              class="p-4 border-t border-ink/5 text-center text-[10px] text-ink/30 uppercase tracking-widest"
            >
              BrutWrite v0.1.0
            </div>
          </div>
