<template>
  <div class="flex-1 w-full flex flex-col items-center justify-center bg-paper text-ink selection:bg-accent/20 overflow-hidden relative">
    ...
    <div class="absolute inset-0 z-0 pointer-events-none opacity-30">
        <div class="absolute top-[10%] left-[5%] w-[40vw] h-[40vw] rounded-full bg-accent/5 blur-[120px] animate-pulse"></div>
        <div class="absolute bottom-[10%] right-[5%] w-[30vw] h-[30vw] rounded-full bg-accent/10 blur-[100px] animate-pulse stagger-1"></div>
    </div>

    <div class="relative z-10 w-full max-w-6xl px-12 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            <div class="space-y-4">
                ...
                <div v-if="recentProjects.length > 0" class="space-y-3">
                    ...
                    >
                        ...
                        <svg class="w-4 h-4 opacity-0 group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0 transition-all text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3" />
                        </svg>
                    </button>
                </div>
                <div v-else class="p-8 border border-dashed border-ink/10 rounded-2xl flex flex-col items-center justify-center text-center space-y-2">
        ...
        <div class="flex flex-col items-center lg:items-end lg:text-right space-y-12 animate-enter stagger-1">
            
            <!-- Logo Container -->
            <div class="space-y-4">
                <div class="relative inline-block mb-8">
                    <h1 class="text-8xl font-serif font-bold italic tracking-tighter leading-none">
                        Brut<span class="relative">Write<span class="absolute bottom-[2px] left-0 w-full h-[2px] bg-accent shadow-[0_0_12px_rgba(255,95,31,0.4)]"></span></span>
                    </h1>
                </div>
            ...
            <div class="w-full max-w-sm space-y-4">
                ...
                >
                    <div class="relative z-10 flex items-center gap-3">
                        <svg class="w-5 h-5 opacity-60 group-hover:rotate-90 transition-transform duration-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                        </svg>
                        <span>Create New Project</span>
                    </div>
                    <div class="absolute inset-0 bg-accent translate-y-full group-hover:translate-y-0 transition-transform duration-500 opacity-10"></div>
                </button>
                ...
                >
                    <svg class="w-5 h-5 opacity-40 group-hover:text-accent group-hover:opacity-100 transition-all" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="lg:hidden w-full space-y-4 pt-8">
                 <h2 class="text-[10px] uppercase tracking-[0.2em] opacity-30 text-center font-bold">Recent Projects</h2>
    ...
    <!-- Minimal Bottom Bar -->
    <div class="absolute bottom-8 left-0 right-0 px-12 flex justify-between items-end opacity-20 text-[10px] uppercase tracking-widest font-bold">
