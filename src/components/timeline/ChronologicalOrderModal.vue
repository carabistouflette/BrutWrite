...
<template>
    ...
    >
        <div class="chrono-modal-content">
            ...
            <p class="description">
                All chapters with temporal data will be reordered to match their chronological
                (story-time) sequence. Chapters without temporal data will be placed at the end.
            </p>
            ...
            <div class="preview-section">
                ...
                <ol class="preview-list">
                    <li v-for="scene in assignedScenes.slice(0, 5)" :key="scene.id" class="preview-item">
                        ...
                        <span class="scene-time">{{ scene.chronological_date || scene.abstract_timeframe }}</span>
                    </li>
