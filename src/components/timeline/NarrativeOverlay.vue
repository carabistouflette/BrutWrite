...
const { connectorPaths, showNarrativeConnectors, toggleConnectors, updateConnectorPositions } =
...
<template>
  <svg v-if="showNarrativeConnectors" class="narrative-overlay" xmlns="http://www.w3.org/2000/svg">
    <defs>
