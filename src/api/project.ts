...
import type { ProjectMetadata, Manifest, Character, ProjectSettings, Plotline, Chapter } from '../types';
...
export const projectApi = {
    ...
    updateNodeMetadata: async (projectId: string, nodeId: string, update: Partial<Chapter>): Promise<ProjectMetadata> => {
